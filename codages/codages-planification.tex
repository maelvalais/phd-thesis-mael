...
\section{Planification par satisfaction de formules logiques}
%
...
\input{codages/codage-efa-sat.tex}

\input{codages/codage-mk99plan.tex}

\input{codages/codage-open-sat.tex}
...
% PLANIFICATION QBF
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Codages QBF de référence pour la planification classique}
%
...
\input{codages/codage-qbf-fe.tex}


\input{codages/codage-noop-cte.tex}
...
\input{codages/codage-open-cte.tex}


\input{codages/codage-efa-cte.tex}
...
\input{codages/codage-smt-tlp-gp.tex}
