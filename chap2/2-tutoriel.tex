...
Par exemple, nous pouvons vérifier que chacun des modèles de la formule suivante ne possède qu'une interprétation à vrai :
...
\begin{mdpre}%mdk
\noindent(p~or~q~or~r)~and~(p~=\textgreater{}~not~q)~and~(q~=\textgreater{}~not~r)~and~(r~=\textgreater{}~not~p)%mdk
\end{mdpre}%mdk
...
En \touist, cela donne :
\begin{mdpre}%mdk
\noindent pluie~and~(pluie~=\textgreater{}~routeMouillee)~and~(routeMouillee~=\textgreater{}~danger)~=\textgreater{}~danger%mdk
\end{mdpre}%mdk
...
Quelle est la longueur du plan optimal pour passer de la situation de la figure \ref{fig:ex6a} à la situation \ref{fig:ex6b} ? Cherchez d'abord une solution \enquote{à la main}. 
%......................................................................
\begin{figure}[h]
\begin{subfigure}[b]{0.5\textwidth}
\centering
